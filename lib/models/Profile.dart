...
class Profile extends Model {
  ...
  final List<DishList>? _DishLists;
  ...
  const Profile._internal({required this.id, firstName, lastName, profilePicUrl, Reviews, DishLists, createdAt, updatedAt}): _firstName = firstName, _lastName = lastName, _profilePicUrl = profilePicUrl, _Reviews = Reviews, _DishLists = DishLists, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Profile({String? id, String? firstName, String? lastName, String? profilePicUrl, List<Review>? Reviews, List<DishList>? DishLists}) {
    return Profile._internal(
      ...
      DishLists: DishLists != null ? List<DishList>.unmodifiable(DishLists) : DishLists);
  }
  ...
  Profile copyWith({String? firstName, String? lastName, String? profilePicUrl, List<Review>? Reviews, List<DishList>? DishLists}) {
    return Profile._internal(
      id: id,
    ...
    : id = json['id'],
      ...
      _DishLists = json['DishLists'] is List
        ? (json['DishLists'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => DishList.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'firstName': _firstName, 'lastName': _lastName, 'profilePicUrl': _profilePicUrl, 'Reviews': _Reviews?.map((Review? e) => e?.toJson()).toList(), 'DishLists': _DishLists?.map((DishList? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'firstName': _firstName, 'lastName': _lastName, 'profilePicUrl': _profilePicUrl, 'Reviews': _Reviews, 'DishLists': _DishLists, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
  ...
  static final QueryField DISHLISTS = QueryField(
    fieldName: "DishLists",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'DishList'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
      key: Profile.DISHLISTS,
      isRequired: false,
      ofModelName: 'DishList',
      associatedKey: DishList.PROFILEID
    ));
