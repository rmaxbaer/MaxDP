...
class ReviewImage extends Model {
  ...
  const ReviewImage._internal({required this.id, required reviewID, imageUrl, createdAt, updatedAt}): _reviewID = reviewID, _imageUrl = imageUrl, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory ReviewImage({String? id, required String reviewID, String? imageUrl}) {
  ...
  ReviewImage copyWith({String? reviewID, String? imageUrl}) {
    return ReviewImage._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'reviewID': _reviewID, 'imageUrl': _imageUrl, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'reviewID': _reviewID, 'imageUrl': _imageUrl, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
